...
from procoder.functional import sharp2_indexing
...
class Agent:
    ...
    def run_api_gemini(self, prompt, temperature: float = 1):
        ...
        elif "estimate" in prompt or "tomorrow" in prompt:
            return '{"buy_A":"yes","buy_B":"no","sell_A":"no","sell_B":"yes","loan":"no"}'

        elif "buy" in prompt or "sell" in prompt or "stock" in prompt:
            return '{"action_type":"buy","stock":"stock_a","amount":5}'
